/* CLC WARNINGS:
 *   CONST: pending=1 vdCount=2
 *   CONST: promoted 0 globals to const
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char* argv[]) {
    long long sl_total = 0;;
    long long sl_i = 0;;
        { long long _wl_total = sl_total; long long _wl_i = sl_i;
      while (_wl_i < 100000000) {
        _wl_total += _wl_i;
        _wl_i++;
      }
      sl_total = _wl_total; sl_i = _wl_i;
    }
        printf("%lld\n", (long long)(sl_total));
    return 0;
}