...
const allTestFiles = [
    ...
    { name: 'Template String & Syntax Guard Test', file: 'features/test-template-and-syntax.js', expected: 16, format: 'result', tier: TIER_STANDARD },
    ...
    { name: 'Seed File Runner Test', file: 'seed/test-seed-runner.js', expected: 287, format: 'summary', timeout: 600, tier: TIER_FULL },
